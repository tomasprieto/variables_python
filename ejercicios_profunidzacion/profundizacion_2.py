...
print(nombre_completo, "es el nombre de la persona", documento, " es su dni")

print(nombre_completo, "es el nombre de la persona", edad, "es su edad", altura, "es su altura")